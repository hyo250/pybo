...
from . import models
#3)
from .views import main_views, naver_views, question_views, answer_views, auth_views, naver_movie,chat_views, kakaotalk_views
...
app.register_blueprint(kakaotalk_views.bp)
